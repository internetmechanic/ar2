...
char http_cmd[] = "PUT /devices/aeaa6c6ee506cf798b7361724d89b7ef X-M2X-KEY: f4f7483b590440a030cb4a4d7b0c5393" ""X-M2X-KEY: f4f7483b590440a030cb4a4d7b0c5393" -H "Content-Type: application/json" -d "{ \"value\": \"full\" }" ;
char buffer[512];
